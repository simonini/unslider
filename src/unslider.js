...
(function($, f) {
  var Unslider = function() {
    ...
    _.o = {
      ...
      item_width: 195, // slidable element width
      item_margin: 6
    };
    ...
    _.init = function(el, o) {
      ...
      ul.css({position: 'relative', left: 0, width: (len * (o.item_width+o.item_margin))+'px' });
    ...
    _.to = function(index, callback) {
      ...
      if (!ul.queue('fx').length) {
        ...
        var total_width = o.item_width + o.item_margin;
        el.animate(obj, speed) && ul.animate($.extend({left: '-' + index * (total_width)}, obj), speed, function(data) {
          _.i = index;
